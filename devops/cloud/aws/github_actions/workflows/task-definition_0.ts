module.exports = {
    ...
    "containerDefinitions": [
        {
            "name": "queryparams-6933",
            "image": `${process.env.AWS_ACCOUNT_ID}.dkr.ecr.us-east-1.amazonaws.com/geppetto-generatedcode-testingapp-6933-queryparams:latest`,
